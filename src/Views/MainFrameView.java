...
public class MainFrameView extends javax.swing.JFrame {
    ...
    public MainFrameView(MainFrameController controller) {
    ...
    private void initComponents() {
        ...
        jMenuItemPR.setText("Yêu cầu mua hàng");
        jMenu3.add(jMenuItemPR);
    ...
    public static void main(String args[]) {
        ...
        final MainFrameController controller = new MainFrameController(loginUser);
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainFrameView(controller).setVisible(true);
            }
        });
    }
