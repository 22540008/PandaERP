...
public class PRView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tbPR.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Số CT", "Người tạo", "Ngày tạo", "Ngày sửa", "Trạng thái", "Mã hàng", "Tên hàng", "ĐVT", "Số lượng", "Giá Est (VND)", "Tổng giá"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Long.class
            };
    ...
    public void loadDataItem() {
        ...
        tbItem.getColumnModel().getColumn(3).setCellRenderer(new CurrencyRenderer()); // format VND
    }
    ...
    public void initTablePRdraft() {
        ...
        tablePRdraft.setColumnType(5, Long.class);
...
//        Item item = new Item();
//        item.setMaHang(Integer.parseInt(fieldMaHang_add.getText()));
//        
//        PurchaseRequest pr = new PurchaseRequest(fieldSoCT_add.getText(),
//                fieldUser_add.getText(),
//                date_add.getDate(),
//                date_add.getDate(),
//                0,
//                
